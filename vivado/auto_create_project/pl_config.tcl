  ...
  # connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports fan] [get_bd_intf_pins fan_gpio/GPIO] # NOTE(Diego): rimosso perché di default spenge la ventola
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_ports fan] [get_bd_pins xlconstant_0/dout]
